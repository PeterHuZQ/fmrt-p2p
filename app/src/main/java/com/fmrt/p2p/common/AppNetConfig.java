...
public class AppNetConfig
{
    ...
    //各服务的基本的连接
    //FMRT-SSO
    public static final String FMRT_SSO_BASE_URL="http://192.168.100.52:9081"; //单位wifi外网
    //public static final String FMRT_SSO_BASE_URL="http://192.168.1.104:9081"; //家里外网

    //PTP-LOAN
    public static final String PTP_LOAN_BASE_URL="http://192.168.100.52:9083"; //单位wifi外网
    //public static final String PTP_LOAN_BASE_URL="http://192.168.1.104:9083"; //家里外网

    //PTP-INVEST
    public static final String PTP_INVEST_BASE_URL="http://192.168.100.52:9084"; //单位wifi外网
    //public static final String PTP_INVEST_BASE_URL="http://192.168.1.104:9084"; //家里外网


    //PTP-USERMANAGE
    public static final String PTP_USERMANAGE_BASE_URL="http://192.168.100.52:9080"; //单位wifi外网
